...
import { IElement, IElementDependencies } from "../../../model/IEndevorEntities";
...
describe("Test function retrieveWithDependencies (retrieve element with dependencies)", () => {
    ...
    Object.defineProperty(QueryACMComponents, "queryACMComponents", { value: mockQueryACMComponents });
    ...
    const testIElements: IElement[] = [{elmName: "elmTest1", fullElmName: "elmTest1", elmVVLL: "1100",
                                       ...
                                       {elmName: "elmTest2", fullElmName: "elmTest2", elmVVLL: "1100",
                                        envName: "envTest", sysName: "sysTest", sbsName: "sbsTest",
                                        stgNum: "1", typeName: "COBOL"}];
    const testDependencies: IElementDependencies[] = [{elmName: "depTest1", envName: "envTest", sysName: "sysTest",
                                                       sbsName: "sbsTest", stgNumber: "1", typeName: "COBOL",
    ...
    test("Should preview an element's single dependency in the text editor (happy path)", async () => {
        await retrieveWithDependencies(testEndevorElementNodes[0], testRetrieveEltService);
    ...
    test("Should cancel dependency download, when there are many dependencies and user decides to cancel", async () => {
        ...
        Object.defineProperty(vscode.window, "showWarningMessage", { value: mockShowWarningMessage });
